...
def page_result():
    ...
    summarize_prompt = f"""
    🔴 **משוב על הביצוע שלך בסימולציה** (בעברית בלבד):
    ...
    **בדיקות קריטיות:**  
    ביצעת את הבדיקות הבאות... אך החמצת...  

    **זיהוי היפוגליקמיה:**  
    זיהית נכון/לא זיהית נכון את ההיפוגליקמיה...  
    ...
    **המלצות לשיפור:**  
    ...
    📌 **חשוב:**  
    - אין לסכם את ההוראות, אלא רק לספק משוב ישיר.
    - המשוב צריך להיות בעברית בלבד.
    - אין להשתמש בשפה כללית או מבנית – כתוב ישירות לסטודנט.
    """
