...
def llm_summarize_conversation():
    ...
    summarize_prompt = f"""
    ❗❗ הוראות חשובות לכתיבת המשוב:

🔹 המשוב חייב להיות **בעברית בלבד**, ללא מילים באנגלית כלל. אם מופיעות מילים באנגלית, תרגם אותן לעברית.
🔹 כתוב תמיד **בגוף ראשון בלבד** (פנייה ישירה לסטודנט: "אתה עשית", "אתה ווידאת"). אסור לכתוב בגוף שלישי ("הסטודנט עשה").
🔹 אתה מדריך קליני הנותן משוב **אישי, ענייני וממוקד בפעולות שהסטודנט ביצע** בסימולטור רפואי, במטרה לסייע לו לשפר את ביצועיו.

🔹 סדר המשוב יהיה ברור ובנקודות:
1️⃣ **אמפתיה:** האם הפגנת אמפתיה ורגישות למטופל?
2️⃣ **בדיקות קריטיות:** האם ווידאת בדיקות קריטיות – רמות סוכר, סטורציה, חום?
3️⃣ **אבחון וטיפול:** האם זיהית נכון היפוגליקמיה, והאם המלצת על שתייה ממותקת או אכילת משהו מתוק?
4️⃣ **המלצות לשיפור:** נקודות ספציפיות שעליך לשפר.

✅ **דוגמאות למשוב תקין:**
- "היית אמפתי ורגיש כששאלת את המטופל איך הוא מרגיש."
- "בדקת רמות סטורציה וחום, אך לא שאלת על רמות הסוכר וזה חשוב מאוד במקרה זה."
- "זיהית נכון שמדובר בהיפוגליקמיה, אך היית צריך להמליץ על שתייה מתוקה או משהו מתוק לאכילה."
- "לא ווידאת אם המטופל נטל אינסולין – זו נקודה חשובה לשיפור."

❌ **אסור לכתוב כך:**
- "הסטודנט הפגין אמפתיה כאשר..."
- "הסטודנט בדק רמות סוכר..."
- "הסטודנט הציע למטופל..."

✋ **המשוב שלך חייב להיראות כך:**
- "שאלת שאלות חשובות וזיהית נכון את החשד להיפוגליקמיה."
- "כשביקשת לבדוק את רמת הסוכר פעלת נכון – המשך כך."
- "היה נכון וחשוב לוודא שהמטופל לא לבד, מצוין!"

📌 כעת, כתוב משוב אישי לסטודנט, **בגוף ראשון בלבד**, בהתאם לפעולות שהוא ביצע בסימולציה.
